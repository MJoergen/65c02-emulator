...
.macro set_stat param_1
            load_flag param_1
            pha         ;use stack to load status
            plp
.endmacro

.macro set_a param_1, param_2
            load_flag param_2
            pha         ;use stack to load status
...
.macro set_absx param_1, param_2
            load_flag param_2
            pha         ;use stack to load status
...
.macro tst_ax param_1, param_2, param_3
            php         ;save flags
...
.macro tst_ay param_1, param_2, param_3
            php         ;save flags
...
.macro tst_z param_1, param_2, param_3
            php         ;save flags
            lda zpt
            cmp param_1,x    ;test result
            trap_ne
...
.macro tst_zx param_1, param_2, param_3
            php         ;save flags
            lda zpt,x
            cmp param_1,x    ;test result
            trap_ne
...
.macro tst_abs param_1, param_2, param_3
            php         ;save flags
            lda abst
            cmp param_1,x    ;test result
            trap_ne
...
.macro tst_absx param_1, param_2, param_3
            php         ;save flags
            lda abst,x
            cmp param_1,x    ;test result
            trap_ne
...
jxi_tab .set data_segment + $100 - 7     ;JMP (jxi_tab,x) x=6
ji_tab  .set data_segment + $100 - 3     ;JMP (ji_tab+2)
jxp_tab .set data_segment + $100         ;JMP (jxp_tab-255) x=255
...
.macro bbt param_1
        ...
        lda #(1<<param_1)    ;testing 1 bit on
        sta zpt
        set_a $33,0     ;with flags off
        bbr param_1,zpt,fail1
        bbs param_1,zpt,ok1
...
ok2:   
        ...
        cmp #(1<<param_1)
        trap_ne         ;zp altered
        lda #$ff-(1<<param_1) ;testing 1 bit off
        sta zpt
        set_a $33,0     ;with flags off
        bbs param_1,zpt,fail3
        bbr param_1,zpt,ok3
...
.macro nop_test param_1, param_2
            ldy #$42
            ldx #4-param_2
            .byt  param_1          ;test nop length
        .if param_2 = 1
            dex
            dex
        .endif
        ...
        .endif
            ...
            set_a $ff-param_1,0
            .byt  param_1          ;test nop integrity - flags off
            nop
            nop
            tst_a $ff-param_1,0
            set_a ($aa-param_1)&$ff,$ff
            .byt  param_1          ;test nop integrity - flags on
            nop
            nop
            tst_a ($aa-param_1)&$ff,$ff
            cpy #$42
            trap_ne         ;y changed
            cpx #0
            trap_ne         ;x changed
